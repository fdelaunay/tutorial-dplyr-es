...
write.csv(mov_simple, file="tutorial-dplyr-es/data/movimientos.csv")
zip("tutorial-dplyr-es/data/movimientos.zip", files="tutorial-dplyr-es/data/movimientos.csv")
```
