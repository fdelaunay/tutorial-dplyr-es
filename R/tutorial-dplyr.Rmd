...
```{r}
download.file("https://raw.githubusercontent.com/fdelaunay/tutorial-dplyr-es/master/data/movimientos.csv.zip",
              destfile="movimientos.csv.zip", method="curl")

unzip("movimientos.csv.zip")
movimientos <- read.csv("movimientos.csv")
str(movimientos)
```
